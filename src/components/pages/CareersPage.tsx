        ...
        <div className="max-w-[100rem] mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {whyJoinUs.map((item, index) => (
              ...
              >
                <item.icon className="h-12 w-12 text-neon-teal mb-4 group-hover:scale-110 transition-transform" />
          ...
          <div className="space-y-12">
            {positions.map((position, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className="bg-background border border-neon-teal/20 rounded-lg overflow-hidden hover:border-neon-teal/50 transition-all"
              >
                {/* Header */}
                <div className="bg-gradient-to-r from-neon-teal/10 to-primary/10 p-8 border-b border-neon-teal/20">
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
                    <div>
                      <h3 className="font-heading text-3xl text-white mb-2">
                        {position.title}
                      </h3>
                      <p className="font-paragraph text-sm text-neon-teal uppercase tracking-wider">
                        {position.department}
                      </p>
                    </div>
                    <div className="inline-block px-4 py-2 bg-neon-teal/10 border border-neon-teal/30 rounded">
                ...
                <div className="p-8">
                  {/* Description */}
                  <div className="mb-8">
                    <p className="font-paragraph text-base text-light-gray leading-relaxed">
                  ...
                  <div className="pt-8 border-t border-neon-teal/20">
                    <div className="bg-deep-space-blue p-6 rounded-lg mb-6">
                      <h4 className="font-heading text-lg text-white mb-3">
                        How to Apply
                      </h4>
                      <p className="font-paragraph text-base text-light-gray mb-4">
                      ...
                      <a
                        ...
                        className="inline-block px-6 py-3 bg-neon-teal/10 border border-neon-teal/30 rounded hover:bg-neon-teal/20 transition-colors"
                      >
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="bg-deep-space-blue border border-neon-teal/20 p-8 rounded-lg text-center h-full">
